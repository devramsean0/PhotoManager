/*
    This code is almost entirely taken from Inquire's example code.
    The original code can be found at: https://github.com/mikaelmello/inquire/blob/42b95d37777af41795201bc71df5411082823821/inquire/examples/complex_autocompletion.rs
*/
